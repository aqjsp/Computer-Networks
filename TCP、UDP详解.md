...
![image-20231217215805553](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110209914.png)

2. TCP的连接套接字连接两端的插口包含IP和端口号。全双工抽象连接。

## 2、TCP的报文格式

![image-20231217215845973](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110209115.png)
...
![image-20231217215904583](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110209222.png)
...
![image-20231217215920699](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110209965.png)
...
![image-20231217215935885](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210294.png)

发送窗口只是发送缓冲区的一部分，发送缓冲区通常包括发送方应用程序传送给发送方TCP准备发送的数据。这里面包括已发送但还未收到确认的数据和未发送但在发送窗口的数据以及未发送但不再发送窗口的数据。

![image-20231217215948843](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210681.png)
...
![image-20231217220001833](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210618.png)
...
![image-20231217220017905](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210798.png)
...
![image-20231217220031814](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210413.png)
...
![image-20231217220044886](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210848.png)
...
![image-20231217220059064](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210562.png)
...
![image-20231217220114781](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210344.png)
...
![image-20231217220129847](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210492.png)
...
![image-20231217220159140](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210323.png)

#### 6.6.3、快重传

快重传算法要求接收方不要等待自己发送数据时才进行捎带确认，而是要立即发送确认，即使收到了失序的报文也要立即发出对已收到的报文段的重复确认。发送方只需要一连收到3个重复确认就立即重传这样就不会出现超时。

![image-20231217220214363](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401120005916.png)
...
![image-20231217220231343](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210006.png)
...
![image-20231217220245159](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110210199.png)

一开始A向B发出建立连接的请求但是这个报文超时了，A又向B发送了一个请求连接报文然后通过两次握手建立连接传送数据最后释放连接。但是这时候，超时的报文迟到发送他们又会建立连接然后服务端等待发送数据，但是这时候客户端已经没有数据可发了。

#### 7.1.4、三次握手的原因

![image-20231217220258053](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110211268.png)
...
![image-20231217220312882](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110211922.png)
...
![image-20231217220328822](https://raw.githubusercontent.com/aqinzz/Pictures/main/202401110211503.png)
